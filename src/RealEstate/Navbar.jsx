                ...
                </div>
                {
                    nav && (
                        <div className="w-[60%] h-screen fixed top-0 left-0 z-50 bg-estate-primary py-4 px-4">
                            <div>
                                <Link onClick={() => setNav(!nav)} to="/miora/"><img className="w-40 h-14" src={mioralogo} alt="Miora Logo" /></Link>
                            </div>
                            ...
                            <div className="flex flex-col gap-2 text-lg font-semibold">
                                ...
                                <button onClick={() => setNav(!nav)} className="bg-estate-secondary text-white py-2 px-5 rounded-md hover:bg-teal-700">LogIn</button>
                            </div>
                        </div>
                    )
                }
